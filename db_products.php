...
$db_products = [
    //PRODOTTI PER CANI 
    new Dog_product('Crocchette Per Cani Adulti', 'Alimentazione', '€50,00 (12 kg)', '20%'),
    new Dog_product('Cibo Umido per Cani','Alimentazione', '€1,50 (400 g)'),
    new Dog_product('Guinzaglio in Nylon','Accessori','€15,00'),
    new Dog_product('Collare Regolabile','Accessori',' €10,00', '30%'),
    new Dog_product('Pettorina per Cani','Accessori','€25,00'),
    new Dog_product('Giocattolo in Gomma','Giocattoli',' €8,00', '15%'),
    ...
    new Dog_product('Trasportino per Cani','Trasporto',' €70,00', '15%'),
